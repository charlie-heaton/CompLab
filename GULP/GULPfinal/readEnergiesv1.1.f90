...
integer, parameter :: dp = selected_real_kind(15,300)
real(kind=dp) :: MgO, MgO_Ca, MgO_2Ca, MgO_3Ca, MgO_4Ca, getEnergy

open(10,file = 'MgO.gout', status = 'old', iostat = istat )
open(11,file = 'MgO_Ca.gout', status = 'old', iostat = istat )
...
print *, Mgo, mgo_ca, mgo_2ca, mgo_3ca, mgo_4ca

open(unit=15, file = 'energies.dat', status = 'replace', iostat = istat2)
if (istat2.ne.0) then
 print *, 'Error creating file'
end if
write(15, *, iostat = istat3) 0, MgO
write(15, *, iostat = istat3) 0.25, MgO_Ca
